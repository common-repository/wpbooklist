<?php
/**
 * WPBookList_StoryTime_Default_Tab Class - class-admin-storytime-tab-ui.php.
 *
 * @author   Jake Evans
 * @category Admin
...
if ( ! class_exists( 'WPBookList_StoryTime_Default_Tab', false ) ) :
	/**
	 * WPBookList_StoryTime_Default_Tab Class.
	 */
	class WPBookList_StoryTime_Default_Tab {
		...
		public function __construct() {
			...
			require_once CLASS_STORYTIME_DIR . 'class-wpbooklist-storytime-form.php';
		...
		private function output_tab_content() {
			echo $this->form->output_storytime_form();
		}
...
// Instantiate the class.
$am = new WPBookList_StoryTime_Default_Tab();
