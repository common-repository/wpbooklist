<?php
/**
 * WPBookList Book Display Options Tab Class
 *
 * @author   Jake Evans
 * @category Admin
...
if ( ! class_exists( 'WPBookList_Book_Display_Options_Tab', false ) ) :
/**
 * WPBookList_Admin_Menu Class.
 */
class WPBookList_Book_Display_Options_Tab {
	...
	public function __construct() {
		...
		require_once(CLASS_DIR.'class-wpbooklist-book-display-options-form.php');
		// Instantiate the class
		$this->template = new WPBookList_Admin_UI_Template;
		$this->form = new WPBookList_Book_Display_Options_Form ;
	...
	private function output_open_admin_container(){
		$title = $this->trans->trans_263;
		$icon_url = ROOT_IMG_ICONS_URL.'library-options.svg';
		echo $this->template->output_open_admin_container($title, $icon_url);
	}

	private function output_tab_content(){
		echo $this->form->output_book_display_options_form();
	}
...
// Instantiate the class
$am = new WPBookList_Book_Display_Options_Tab;