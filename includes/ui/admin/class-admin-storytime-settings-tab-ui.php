<?php
/**
 * WPBookList_StoryTime_Settings_Default_Tab Class - class-admin-storytime-settings-tab-ui.php.
 *
 * @author   Jake Evans
 * @category Admin
...
if ( ! class_exists( 'WPBookList_StoryTime_Settings_Default_Tab', false ) ) :
	/**
	 * WPBookList_StoryTime_Settings_Default_Tab Class.
	 */
	class WPBookList_StoryTime_Settings_Default_Tab {
		...
		public function __construct() {
			...
			require_once CLASS_STORYTIME_DIR . 'class-wpbooklist-storytime-settings-form.php';
			...
			$this->form     = new WPBookList_Storytime_Settings_Form();
		...
		private function output_open_admin_container() {
			$icon_url = ROOT_IMG_ICONS_URL . 'guide.svg';
			$title    = $this->trans->trans_300;
...
// Instantiate the class.
$am = new WPBookList_StoryTime_Settings_Default_Tab();
